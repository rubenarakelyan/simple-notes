...
@section('content')
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <p>{{ $note->text }}</p>
            <p>
                <a href="/" class="btn btn-default btn-raised"><span class="glyphicon glyphicon-chevron-left"></span> Back to overview</a>
                <a href="/note/{{ $note->id }}/comment" class="btn btn-success btn-raised pull-right">Add additional note <span class="glyphicon glyphicon-chevron-right"></span></a>
            </p>
            <hr />
